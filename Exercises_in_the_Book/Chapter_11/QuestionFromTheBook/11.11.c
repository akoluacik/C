...
void initialize_with_data(struct person person[]){
    strcpy(person[1].firstname, "Anil");
    strcpy(person[1].lastname, "Koluacik");
    strcpy(person[1].age, "22");

    strcpy(person[2].firstname, "Emirhan");
    strcpy(person[2].lastname, "Portakal");
    strcpy(person[2].age, "21");

    strcpy(person[3].firstname, "Mali");
    strcpy(person[3].lastname, "Korkusuz");
